/-!
# standard-conjectures-on-algebraic-cycles-canonical-lane Lean migration boundary
...
`StandardConjecturesOnAlgebraicCyclesCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "standard-conjectures-on-algebraic-cycles-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/standard-conjectures-on-algebraic-cycles-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the standard conjectures on algebraic cycles: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-cycles", "algebraic-geometry", "mathematical-proof", "motives", "reproducibility", "lefschetz", "standard-conjectures", "canonical-lane", "local-to-global", "manifold-constrained"]
