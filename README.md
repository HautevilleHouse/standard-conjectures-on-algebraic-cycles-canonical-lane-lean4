# Standard Conjectures on Algebraic Cycles — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/standard-conjectures-on-algebraic-cycles-canonical-lane-mathlib.git
cd standard-conjectures-on-algebraic-cycles-canonical-lane-mathlib
lake exe
lake build
```
